...
use App\Policies\DepartmentHandoffReviewPolicy;
...
#[Table('department_handoff_reviews')]
#[Fillable(['handoff_version_id', 'reviewer_personnel_id', 'decision', 'comment', 'decided_at'])]
#[UsePolicy(DepartmentHandoffReviewPolicy::class)]
class DepartmentHandoffReview extends Model
{
