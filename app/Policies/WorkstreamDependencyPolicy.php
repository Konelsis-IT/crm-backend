...
final class WorkstreamDependencyPolicy
{
    ...
    public function view(Personnel $personnel, WorkstreamDependency $record): bool
    {
    ...
    public function update(Personnel $personnel, WorkstreamDependency $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, WorkstreamDependency $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, WorkstreamDependency $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, WorkstreamDependency $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, WorkstreamDependency $record): bool
    {
        return false;
    }
