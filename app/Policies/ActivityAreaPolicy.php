...
final class ActivityAreaPolicy
{
    ...
    public function view(Personnel $personnel, ActivityArea $record): bool
    {
    ...
    public function update(Personnel $personnel, ActivityArea $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ActivityArea $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ActivityArea $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ActivityArea $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ActivityArea $record): bool
    {
        return false;
    }
