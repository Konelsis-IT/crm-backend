...
final class PartyAnnualReviewPolicy
{
    ...
    public function view(Personnel $personnel, PartyAnnualReview $record): bool
    {
    ...
    public function update(Personnel $personnel, PartyAnnualReview $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, PartyAnnualReview $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, PartyAnnualReview $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, PartyAnnualReview $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, PartyAnnualReview $record): bool
    {
        return false;
    }
