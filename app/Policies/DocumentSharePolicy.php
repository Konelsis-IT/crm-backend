...
final class DocumentSharePolicy
{
    ...
    public function view(Personnel $personnel, DocumentShare $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentShare $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentShare $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DocumentShare $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentShare $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentShare $record): bool
    {
        return false;
    }
