...
final class ApprovalPolicyVersionPolicy
{
    ...
    public function view(Personnel $personnel, ApprovalPolicyVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, ApprovalPolicyVersion $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ApprovalPolicyVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ApprovalPolicyVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ApprovalPolicyVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ApprovalPolicyVersion $record): bool
    {
        return false;
    }
