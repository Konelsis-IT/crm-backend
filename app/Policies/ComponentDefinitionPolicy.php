...
final class ComponentDefinitionPolicy
{
    ...
    public function view(Personnel $personnel, ComponentDefinition $record): bool
    {
    ...
    public function update(Personnel $personnel, ComponentDefinition $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ComponentDefinition $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ComponentDefinition $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ComponentDefinition $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ComponentDefinition $record): bool
    {
        return false;
    }
