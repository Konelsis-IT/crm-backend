...
final class AddressPolicy
{
    ...
    public function view(Personnel $personnel, Address $record): bool
    {
    ...
    public function update(Personnel $personnel, Address $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Address $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, Address $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Address $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Address $record): bool
    {
        return false;
    }
