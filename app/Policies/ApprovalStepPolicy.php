...
final class ApprovalStepPolicy
{
    ...
    public function view(Personnel $personnel, ApprovalStep $record): bool
    {
    ...
    public function update(Personnel $personnel, ApprovalStep $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ApprovalStep $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ApprovalStep $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ApprovalStep $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ApprovalStep $record): bool
    {
        return false;
    }
