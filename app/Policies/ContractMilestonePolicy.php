...
final class ContractMilestonePolicy
{
    ...
    public function view(Personnel $personnel, ContractMilestone $record): bool
    {
    ...
    public function update(Personnel $personnel, ContractMilestone $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ContractMilestone $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ContractMilestone $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ContractMilestone $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ContractMilestone $record): bool
    {
        return false;
    }
