...
final class ProjectComponentPolicy
{
    ...
    public function view(Personnel $personnel, ProjectComponent $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectComponent $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProjectComponent $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProjectComponent $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectComponent $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectComponent $record): bool
    {
        return false;
    }
