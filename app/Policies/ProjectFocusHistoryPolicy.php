...
final class ProjectFocusHistoryPolicy
{
    ...
    public function view(Personnel $personnel, ProjectFocusHistory $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectFocusHistory $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, ProjectFocusHistory $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ProjectFocusHistory $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectFocusHistory $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectFocusHistory $record): bool
    {
        return false;
    }
