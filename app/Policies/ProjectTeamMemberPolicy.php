...
final class ProjectTeamMemberPolicy
{
    ...
    public function view(Personnel $personnel, ProjectTeamMember $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectTeamMember $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProjectTeamMember $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProjectTeamMember $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectTeamMember $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectTeamMember $record): bool
    {
        return false;
    }
