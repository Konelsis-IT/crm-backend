...
final class DocumentRevisionFilePolicy
{
    ...
    public function view(Personnel $personnel, DocumentRevisionFile $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentRevisionFile $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentRevisionFile $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DocumentRevisionFile $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentRevisionFile $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentRevisionFile $record): bool
    {
        return false;
    }
