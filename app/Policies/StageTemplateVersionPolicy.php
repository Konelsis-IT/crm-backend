...
final class StageTemplateVersionPolicy
{
    ...
    public function view(Personnel $personnel, StageTemplateVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, StageTemplateVersion $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, StageTemplateVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, StageTemplateVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, StageTemplateVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, StageTemplateVersion $record): bool
    {
        return false;
    }
