...
final class OpportunityPolicy
{
    ...
    public function view(Personnel $personnel, Opportunity $record): bool
    {
    ...
    public function update(Personnel $personnel, Opportunity $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Opportunity $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Opportunity $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Opportunity $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Opportunity $record): bool
    {
        return false;
    }
