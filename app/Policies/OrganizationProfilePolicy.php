...
final class OrganizationProfilePolicy
{
    ...
    public function view(Personnel $personnel, OrganizationProfile $record): bool
    {
    ...
    public function update(Personnel $personnel, OrganizationProfile $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, OrganizationProfile $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, OrganizationProfile $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, OrganizationProfile $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, OrganizationProfile $record): bool
    {
        return false;
    }
