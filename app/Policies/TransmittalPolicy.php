...
final class TransmittalPolicy
{
    ...
    public function view(Personnel $personnel, Transmittal $record): bool
    {
    ...
    public function update(Personnel $personnel, Transmittal $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Transmittal $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Transmittal $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Transmittal $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Transmittal $record): bool
    {
        return false;
    }
