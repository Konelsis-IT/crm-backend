...
final class ProjectSupplyItemPolicy
{
    ...
    public function view(Personnel $personnel, ProjectSupplyItem $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectSupplyItem $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProjectSupplyItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProjectSupplyItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectSupplyItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectSupplyItem $record): bool
    {
        return false;
    }
