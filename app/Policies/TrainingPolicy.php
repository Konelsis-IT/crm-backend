...
final class TrainingPolicy
{
    ...
    public function view(Personnel $personnel, Training $record): bool
    {
    ...
    public function update(Personnel $personnel, Training $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Training $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Training $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Training $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Training $record): bool
    {
        return false;
    }
