...
final class StageDependencyPolicy
{
    ...
    public function view(Personnel $personnel, StageDependency $record): bool
    {
    ...
    public function update(Personnel $personnel, StageDependency $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, StageDependency $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, StageDependency $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, StageDependency $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, StageDependency $record): bool
    {
        return false;
    }
