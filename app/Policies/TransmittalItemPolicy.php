...
final class TransmittalItemPolicy
{
    ...
    public function view(Personnel $personnel, TransmittalItem $record): bool
    {
    ...
    public function update(Personnel $personnel, TransmittalItem $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, TransmittalItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, TransmittalItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, TransmittalItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, TransmittalItem $record): bool
    {
        return false;
    }
