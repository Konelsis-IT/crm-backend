...
final class HandoffItemPolicy
{
    ...
    public function view(Personnel $personnel, HandoffItem $record): bool
    {
    ...
    public function update(Personnel $personnel, HandoffItem $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, HandoffItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, HandoffItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, HandoffItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, HandoffItem $record): bool
    {
        return false;
    }
