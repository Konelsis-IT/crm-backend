...
final class ContractPolicy
{
    ...
    public function view(Personnel $personnel, Contract $record): bool
    {
    ...
    public function update(Personnel $personnel, Contract $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Contract $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Contract $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Contract $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Contract $record): bool
    {
        return false;
    }
