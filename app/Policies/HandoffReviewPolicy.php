...
final class HandoffReviewPolicy
{
    ...
    public function view(Personnel $personnel, HandoffReview $record): bool
    {
    ...
    public function update(Personnel $personnel, HandoffReview $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, HandoffReview $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, HandoffReview $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, HandoffReview $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, HandoffReview $record): bool
    {
        return false;
    }
