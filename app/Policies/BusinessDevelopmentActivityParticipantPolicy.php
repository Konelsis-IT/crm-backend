...
final class BusinessDevelopmentActivityParticipantPolicy
{
    ...
    public function view(Personnel $personnel, BusinessDevelopmentActivityParticipant $record): bool
    {
    ...
    public function update(Personnel $personnel, BusinessDevelopmentActivityParticipant $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, BusinessDevelopmentActivityParticipant $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, BusinessDevelopmentActivityParticipant $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, BusinessDevelopmentActivityParticipant $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, BusinessDevelopmentActivityParticipant $record): bool
    {
        return false;
    }
