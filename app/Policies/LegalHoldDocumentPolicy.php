...
final class LegalHoldDocumentPolicy
{
    ...
    public function view(Personnel $personnel, LegalHoldDocument $record): bool
    {
    ...
    public function update(Personnel $personnel, LegalHoldDocument $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, LegalHoldDocument $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, LegalHoldDocument $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, LegalHoldDocument $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, LegalHoldDocument $record): bool
    {
        return false;
    }
