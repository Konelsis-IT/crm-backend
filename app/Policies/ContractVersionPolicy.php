...
final class ContractVersionPolicy
{
    ...
    public function view(Personnel $personnel, ContractVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, ContractVersion $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ContractVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ContractVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ContractVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ContractVersion $record): bool
    {
        return false;
    }
