...
final class StageEvidencePolicy
{
    ...
    public function view(Personnel $personnel, StageEvidence $record): bool
    {
    ...
    public function update(Personnel $personnel, StageEvidence $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, StageEvidence $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, StageEvidence $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, StageEvidence $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, StageEvidence $record): bool
    {
        return false;
    }
