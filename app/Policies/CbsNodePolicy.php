...
final class CbsNodePolicy
{
    ...
    public function view(Personnel $personnel, CbsNode $record): bool
    {
    ...
    public function update(Personnel $personnel, CbsNode $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, CbsNode $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, CbsNode $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, CbsNode $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, CbsNode $record): bool
    {
        return false;
    }
