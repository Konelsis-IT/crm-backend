...
final class DepartmentHandoffVersionPolicy
{
    ...
    public function view(Personnel $personnel, DepartmentHandoffVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, DepartmentHandoffVersion $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DepartmentHandoffVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DepartmentHandoffVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DepartmentHandoffVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DepartmentHandoffVersion $record): bool
    {
        return false;
    }
