...
final class WorkPackagePolicy
{
    ...
    public function view(Personnel $personnel, WorkPackage $record): bool
    {
    ...
    public function update(Personnel $personnel, WorkPackage $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, WorkPackage $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, WorkPackage $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, WorkPackage $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, WorkPackage $record): bool
    {
        return false;
    }
