...
final class DocumentPolicy
{
    ...
    public function view(Personnel $personnel, Document $record): bool
    {
    ...
    public function update(Personnel $personnel, Document $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Document $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Document $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Document $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Document $record): bool
    {
        return false;
    }
