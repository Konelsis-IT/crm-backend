...
final class ApprovalRequestStepPolicy
{
    ...
    public function view(Personnel $personnel, ApprovalRequestStep $record): bool
    {
    ...
    public function update(Personnel $personnel, ApprovalRequestStep $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, ApprovalRequestStep $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ApprovalRequestStep $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ApprovalRequestStep $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ApprovalRequestStep $record): bool
    {
        return false;
    }
