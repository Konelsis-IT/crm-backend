...
final class ProjectIssuePolicy
{
    ...
    public function view(Personnel $personnel, ProjectIssue $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectIssue $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProjectIssue $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ProjectIssue $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectIssue $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectIssue $record): bool
    {
        return false;
    }
