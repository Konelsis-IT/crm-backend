...
final class DocumentTemplateVersionPolicy
{
    ...
    public function view(Personnel $personnel, DocumentTemplateVersion $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DocumentTemplateVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentTemplateVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentTemplateVersion $record): bool
    {
        return false;
    }
