...
final class PartyCertificatePolicy
{
    ...
    public function view(Personnel $personnel, PartyCertificate $record): bool
    {
    ...
    public function update(Personnel $personnel, PartyCertificate $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, PartyCertificate $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, PartyCertificate $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, PartyCertificate $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, PartyCertificate $record): bool
    {
        return false;
    }
