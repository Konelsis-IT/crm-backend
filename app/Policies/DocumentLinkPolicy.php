...
final class DocumentLinkPolicy
{
    ...
    public function view(Personnel $personnel, DocumentLink $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentLink $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentLink $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DocumentLink $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentLink $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentLink $record): bool
    {
        return false;
    }
