...
final class ApprovalPolicyPolicy
{
    ...
    public function view(Personnel $personnel, ApprovalPolicy $record): bool
    {
    ...
    public function update(Personnel $personnel, ApprovalPolicy $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ApprovalPolicy $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ApprovalPolicy $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ApprovalPolicy $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ApprovalPolicy $record): bool
    {
        return false;
    }
