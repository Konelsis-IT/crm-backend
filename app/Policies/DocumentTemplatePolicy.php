...
final class DocumentTemplatePolicy
{
    ...
    public function view(Personnel $personnel, DocumentTemplate $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentTemplate $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentTemplate $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DocumentTemplate $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentTemplate $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentTemplate $record): bool
    {
        return false;
    }
