...
final class EstimateVersionPolicy
{
    ...
    public function view(Personnel $personnel, EstimateVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, EstimateVersion $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, EstimateVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, EstimateVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, EstimateVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, EstimateVersion $record): bool
    {
        return false;
    }
