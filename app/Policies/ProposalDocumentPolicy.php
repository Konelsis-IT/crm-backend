...
final class ProposalDocumentPolicy
{
    ...
    public function view(Personnel $personnel, ProposalDocument $record): bool
    {
    ...
    public function update(Personnel $personnel, ProposalDocument $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProposalDocument $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProposalDocument $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProposalDocument $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProposalDocument $record): bool
    {
        return false;
    }
