...
final class OrgUnitRelationPolicy
{
    ...
    public function view(Personnel $personnel, OrgUnitRelation $record): bool
    {
    ...
    public function update(Personnel $personnel, OrgUnitRelation $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, OrgUnitRelation $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, OrgUnitRelation $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, OrgUnitRelation $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, OrgUnitRelation $record): bool
    {
        return false;
    }
