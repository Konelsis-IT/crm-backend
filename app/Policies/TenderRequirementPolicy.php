...
final class TenderRequirementPolicy
{
    ...
    public function view(Personnel $personnel, TenderRequirement $record): bool
    {
    ...
    public function update(Personnel $personnel, TenderRequirement $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, TenderRequirement $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, TenderRequirement $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, TenderRequirement $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, TenderRequirement $record): bool
    {
        return false;
    }
