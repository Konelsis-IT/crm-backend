...
final class WorkPackageDependencyPolicy
{
    ...
    public function view(Personnel $personnel, WorkPackageDependency $record): bool
    {
    ...
    public function update(Personnel $personnel, WorkPackageDependency $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, WorkPackageDependency $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, WorkPackageDependency $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, WorkPackageDependency $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, WorkPackageDependency $record): bool
    {
        return false;
    }
