...
final class ProjectPhotoPolicy
{
    ...
    public function view(Personnel $personnel, ProjectPhoto $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectPhoto $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProjectPhoto $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProjectPhoto $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectPhoto $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectPhoto $record): bool
    {
        return false;
    }
