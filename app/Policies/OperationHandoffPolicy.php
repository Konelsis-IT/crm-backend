...
final class OperationHandoffPolicy
{
    ...
    public function view(Personnel $personnel, OperationHandoff $record): bool
    {
    ...
    public function update(Personnel $personnel, OperationHandoff $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, OperationHandoff $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, OperationHandoff $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, OperationHandoff $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, OperationHandoff $record): bool
    {
        return false;
    }
