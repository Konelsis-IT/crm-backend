...
final class CertificationPolicy
{
    ...
    public function view(Personnel $personnel, Certification $record): bool
    {
    ...
    public function update(Personnel $personnel, Certification $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Certification $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Certification $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Certification $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Certification $record): bool
    {
        return false;
    }
