...
final class StageRequirementDefinitionPolicy
{
    ...
    public function view(Personnel $personnel, StageRequirementDefinition $record): bool
    {
    ...
    public function update(Personnel $personnel, StageRequirementDefinition $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, StageRequirementDefinition $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, StageRequirementDefinition $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, StageRequirementDefinition $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, StageRequirementDefinition $record): bool
    {
        return false;
    }
