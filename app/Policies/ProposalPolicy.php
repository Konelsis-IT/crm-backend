...
final class ProposalPolicy
{
    ...
    public function view(Personnel $personnel, Proposal $record): bool
    {
    ...
    public function update(Personnel $personnel, Proposal $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Proposal $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Proposal $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Proposal $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Proposal $record): bool
    {
        return false;
    }
