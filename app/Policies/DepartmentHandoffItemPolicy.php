...
final class DepartmentHandoffItemPolicy
{
    ...
    public function view(Personnel $personnel, DepartmentHandoffItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DepartmentHandoffItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DepartmentHandoffItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DepartmentHandoffItem $record): bool
    {
        return false;
    }
