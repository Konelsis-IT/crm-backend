...
final class DocumentReviewPolicy
{
    ...
    public function view(Personnel $personnel, DocumentReview $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentReview $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentReview $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DocumentReview $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentReview $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentReview $record): bool
    {
        return false;
    }
