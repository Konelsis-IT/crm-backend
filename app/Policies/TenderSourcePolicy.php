...
final class TenderSourcePolicy
{
    ...
    public function view(Personnel $personnel, TenderSource $record): bool
    {
    ...
    public function update(Personnel $personnel, TenderSource $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, TenderSource $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, TenderSource $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, TenderSource $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, TenderSource $record): bool
    {
        return false;
    }
