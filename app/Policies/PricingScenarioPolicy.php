...
final class PricingScenarioPolicy
{
    ...
    public function view(Personnel $personnel, PricingScenario $record): bool
    {
    ...
    public function update(Personnel $personnel, PricingScenario $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, PricingScenario $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, PricingScenario $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, PricingScenario $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, PricingScenario $record): bool
    {
        return false;
    }
