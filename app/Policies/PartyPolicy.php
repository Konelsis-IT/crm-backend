...
final class PartyPolicy
{
    ...
    public function view(Personnel $personnel, Party $record): bool
    {
    ...
    public function update(Personnel $personnel, Party $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Party $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Party $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Party $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Party $record): bool
    {
        return false;
    }
