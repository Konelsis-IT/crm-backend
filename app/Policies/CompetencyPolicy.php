...
final class CompetencyPolicy
{
    ...
    public function view(Personnel $personnel, Competency $record): bool
    {
    ...
    public function update(Personnel $personnel, Competency $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Competency $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Competency $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Competency $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Competency $record): bool
    {
        return false;
    }
