...
final class BusinessCaseScopePolicy
{
    ...
    public function view(Personnel $personnel, BusinessCaseScope $record): bool
    {
    ...
    public function update(Personnel $personnel, BusinessCaseScope $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, BusinessCaseScope $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, BusinessCaseScope $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, BusinessCaseScope $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, BusinessCaseScope $record): bool
    {
        return false;
    }
