...
final class TrainingAttendancePolicy
{
    ...
    public function view(Personnel $personnel, TrainingAttendance $record): bool
    {
    ...
    public function update(Personnel $personnel, TrainingAttendance $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, TrainingAttendance $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, TrainingAttendance $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, TrainingAttendance $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, TrainingAttendance $record): bool
    {
        return false;
    }
