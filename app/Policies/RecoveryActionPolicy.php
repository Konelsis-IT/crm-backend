...
final class RecoveryActionPolicy
{
    ...
    public function view(Personnel $personnel, RecoveryAction $record): bool
    {
    ...
    public function update(Personnel $personnel, RecoveryAction $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, RecoveryAction $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, RecoveryAction $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, RecoveryAction $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, RecoveryAction $record): bool
    {
        return false;
    }
