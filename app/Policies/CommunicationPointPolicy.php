...
final class CommunicationPointPolicy
{
    ...
    public function view(Personnel $personnel, CommunicationPoint $record): bool
    {
    ...
    public function update(Personnel $personnel, CommunicationPoint $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, CommunicationPoint $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, CommunicationPoint $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, CommunicationPoint $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, CommunicationPoint $record): bool
    {
        return false;
    }
