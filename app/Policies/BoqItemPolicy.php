...
final class BoqItemPolicy
{
    ...
    public function view(Personnel $personnel, BoqItem $record): bool
    {
    ...
    public function update(Personnel $personnel, BoqItem $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, BoqItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, BoqItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, BoqItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, BoqItem $record): bool
    {
        return false;
    }
