...
final class ProjectChangePolicy
{
    ...
    public function view(Personnel $personnel, ProjectChange $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectChange $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProjectChange $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ProjectChange $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectChange $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectChange $record): bool
    {
        return false;
    }
