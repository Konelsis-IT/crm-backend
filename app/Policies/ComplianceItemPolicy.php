...
final class ComplianceItemPolicy
{
    ...
    public function view(Personnel $personnel, ComplianceItem $record): bool
    {
    ...
    public function update(Personnel $personnel, ComplianceItem $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ComplianceItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ComplianceItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ComplianceItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ComplianceItem $record): bool
    {
        return false;
    }
