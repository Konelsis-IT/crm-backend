...
final class OrgUnitPolicy
{
    ...
    public function view(Personnel $personnel, OrgUnit $record): bool
    {
    ...
    public function update(Personnel $personnel, OrgUnit $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, OrgUnit $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, OrgUnit $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, OrgUnit $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, OrgUnit $record): bool
    {
        return false;
    }
