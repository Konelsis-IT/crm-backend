...
final class PersonnelAssignmentPolicy
{
    ...
    public function view(Personnel $personnel, PersonnelAssignment $record): bool
    {
    ...
    public function update(Personnel $personnel, PersonnelAssignment $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, PersonnelAssignment $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, PersonnelAssignment $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, PersonnelAssignment $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, PersonnelAssignment $record): bool
    {
        return false;
    }
