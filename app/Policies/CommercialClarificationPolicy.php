...
final class CommercialClarificationPolicy
{
    ...
    public function view(Personnel $personnel, CommercialClarification $record): bool
    {
    ...
    public function update(Personnel $personnel, CommercialClarification $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, CommercialClarification $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, CommercialClarification $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, CommercialClarification $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, CommercialClarification $record): bool
    {
        return false;
    }
