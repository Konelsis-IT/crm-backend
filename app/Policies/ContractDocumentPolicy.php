...
final class ContractDocumentPolicy
{
    ...
    public function view(Personnel $personnel, ContractDocument $record): bool
    {
    ...
    public function update(Personnel $personnel, ContractDocument $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ContractDocument $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ContractDocument $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ContractDocument $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ContractDocument $record): bool
    {
        return false;
    }
