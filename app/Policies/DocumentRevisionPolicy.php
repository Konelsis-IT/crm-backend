...
final class DocumentRevisionPolicy
{
    ...
    public function view(Personnel $personnel, DocumentRevision $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentRevision $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentRevision $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DocumentRevision $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentRevision $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentRevision $record): bool
    {
        return false;
    }
