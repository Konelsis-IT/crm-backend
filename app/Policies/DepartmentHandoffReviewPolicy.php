...
final class DepartmentHandoffReviewPolicy
{
    ...
    public function view(Personnel $personnel, DepartmentHandoffReview $record): bool
    {
    ...
    public function delete(Personnel $personnel, DepartmentHandoffReview $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DepartmentHandoffReview $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DepartmentHandoffReview $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DepartmentHandoffReview $record): bool
    {
        return false;
    }
