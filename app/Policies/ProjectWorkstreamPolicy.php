...
final class ProjectWorkstreamPolicy
{
    ...
    public function view(Personnel $personnel, ProjectWorkstream $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProjectWorkstream $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectWorkstream $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectWorkstream $record): bool
    {
        return false;
    }
