...
final class DepartmentHandoffPolicy
{
    ...
    public function view(Personnel $personnel, DepartmentHandoff $record): bool
    {
    ...
    public function update(Personnel $personnel, DepartmentHandoff $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DepartmentHandoff $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DepartmentHandoff $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DepartmentHandoff $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DepartmentHandoff $record): bool
    {
        return false;
    }
