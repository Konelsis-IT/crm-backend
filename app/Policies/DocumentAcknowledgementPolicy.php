...
final class DocumentAcknowledgementPolicy
{
    ...
    public function view(Personnel $personnel, DocumentAcknowledgement $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentAcknowledgement $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentAcknowledgement $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DocumentAcknowledgement $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentAcknowledgement $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentAcknowledgement $record): bool
    {
        return false;
    }
