...
final class ProjectPolicy
{
    ...
    public function view(Personnel $personnel, Project $record): bool
    {
    ...
    public function update(Personnel $personnel, Project $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Project $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, Project $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Project $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Project $record): bool
    {
        return false;
    }
