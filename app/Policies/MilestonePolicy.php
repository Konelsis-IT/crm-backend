...
final class MilestonePolicy
{
    ...
    public function view(Personnel $personnel, Milestone $record): bool
    {
    ...
    public function update(Personnel $personnel, Milestone $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, Milestone $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, Milestone $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, Milestone $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, Milestone $record): bool
    {
        return false;
    }
