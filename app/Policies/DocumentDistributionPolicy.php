...
final class DocumentDistributionPolicy
{
    ...
    public function view(Personnel $personnel, DocumentDistribution $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentDistribution $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentDistribution $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, DocumentDistribution $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentDistribution $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentDistribution $record): bool
    {
        return false;
    }
