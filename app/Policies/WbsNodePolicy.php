...
final class WbsNodePolicy
{
    ...
    public function view(Personnel $personnel, WbsNode $record): bool
    {
    ...
    public function update(Personnel $personnel, WbsNode $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, WbsNode $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, WbsNode $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, WbsNode $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, WbsNode $record): bool
    {
        return false;
    }
