...
final class ProjectStageInstancePolicy
{
    ...
    public function view(Personnel $personnel, ProjectStageInstance $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ProjectStageInstance $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectStageInstance $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectStageInstance $record): bool
    {
        return false;
    }
