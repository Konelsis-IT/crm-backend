...
final class DocumentTypePolicy
{
    ...
    public function view(Personnel $personnel, DocumentType $record): bool
    {
    ...
    public function update(Personnel $personnel, DocumentType $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, DocumentType $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, DocumentType $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, DocumentType $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, DocumentType $record): bool
    {
        return false;
    }
