...
final class BrandItemPolicy
{
    ...
    public function view(Personnel $personnel, BrandItem $record): bool
    {
    ...
    public function update(Personnel $personnel, BrandItem $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, BrandItem $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, BrandItem $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, BrandItem $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, BrandItem $record): bool
    {
        return false;
    }
