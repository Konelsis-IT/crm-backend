...
final class StageTemplatePolicy
{
    ...
    public function view(Personnel $personnel, StageTemplate $record): bool
    {
    ...
    public function update(Personnel $personnel, StageTemplate $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, StageTemplate $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, StageTemplate $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, StageTemplate $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, StageTemplate $record): bool
    {
        return false;
    }
