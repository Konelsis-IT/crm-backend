...
final class TenderNoticeVersionPolicy
{
    ...
    public function view(Personnel $personnel, TenderNoticeVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, TenderNoticeVersion $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, TenderNoticeVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, TenderNoticeVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, TenderNoticeVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, TenderNoticeVersion $record): bool
    {
        return false;
    }
