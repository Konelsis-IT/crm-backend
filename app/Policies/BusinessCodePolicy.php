...
final class BusinessCodePolicy
{
    ...
    public function view(Personnel $personnel, BusinessCode $record): bool
    {
    ...
    public function update(Personnel $personnel, BusinessCode $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, BusinessCode $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, BusinessCode $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, BusinessCode $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, BusinessCode $record): bool
    {
        return false;
    }
