...
final class ProjectDecisionPolicy
{
    ...
    public function view(Personnel $personnel, ProjectDecision $record): bool
    {
    ...
    public function update(Personnel $personnel, ProjectDecision $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, ProjectDecision $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ProjectDecision $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProjectDecision $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProjectDecision $record): bool
    {
        return false;
    }
