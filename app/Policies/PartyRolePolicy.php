...
final class PartyRolePolicy
{
    ...
    public function view(Personnel $personnel, PartyRole $record): bool
    {
    ...
    public function update(Personnel $personnel, PartyRole $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, PartyRole $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, PartyRole $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, PartyRole $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, PartyRole $record): bool
    {
        return false;
    }
