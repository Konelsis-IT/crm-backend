...
final class CommercialExposurePolicy
{
    ...
    public function view(Personnel $personnel, CommercialExposure $record): bool
    {
    ...
    public function update(Personnel $personnel, CommercialExposure $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, CommercialExposure $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, CommercialExposure $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, CommercialExposure $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, CommercialExposure $record): bool
    {
        return false;
    }
