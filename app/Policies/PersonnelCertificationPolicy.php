...
final class PersonnelCertificationPolicy
{
    ...
    public function view(Personnel $personnel, PersonnelCertification $record): bool
    {
    ...
    public function update(Personnel $personnel, PersonnelCertification $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, PersonnelCertification $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, PersonnelCertification $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, PersonnelCertification $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, PersonnelCertification $record): bool
    {
        return false;
    }
