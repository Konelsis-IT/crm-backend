...
final class ProposalVersionPolicy
{
    ...
    public function view(Personnel $personnel, ProposalVersion $record): bool
    {
    ...
    public function update(Personnel $personnel, ProposalVersion $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ProposalVersion $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ProposalVersion $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ProposalVersion $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ProposalVersion $record): bool
    {
        return false;
    }
