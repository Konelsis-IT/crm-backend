...
final class StageNodePolicy
{
    ...
    public function view(Personnel $personnel, StageNode $record): bool
    {
    ...
    public function update(Personnel $personnel, StageNode $record): bool
    {
        return $this->hasFullAccess($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, StageNode $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, StageNode $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, StageNode $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, StageNode $record): bool
    {
        return false;
    }
