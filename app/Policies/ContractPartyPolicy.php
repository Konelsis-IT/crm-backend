...
final class ContractPartyPolicy
{
    ...
    public function view(Personnel $personnel, ContractParty $record): bool
    {
    ...
    public function update(Personnel $personnel, ContractParty $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, ContractParty $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, ContractParty $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ContractParty $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ContractParty $record): bool
    {
        return false;
    }
