...
final class OperationGroupDefinitionPolicy
{
    ...
    public function view(Personnel $personnel, OperationGroupDefinition $record): bool
    {
    ...
    public function update(Personnel $personnel, OperationGroupDefinition $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, OperationGroupDefinition $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, OperationGroupDefinition $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, OperationGroupDefinition $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, OperationGroupDefinition $record): bool
    {
        return false;
    }
