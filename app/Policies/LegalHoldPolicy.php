...
final class LegalHoldPolicy
{
    ...
    public function view(Personnel $personnel, LegalHold $record): bool
    {
    ...
    public function update(Personnel $personnel, LegalHold $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, LegalHold $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, LegalHold $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, LegalHold $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, LegalHold $record): bool
    {
        return false;
    }
