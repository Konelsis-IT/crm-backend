...
final class ApprovalDecisionPolicy
{
    ...
    public function view(Personnel $personnel, ApprovalDecision $record): bool
    {
    ...
    public function update(Personnel $personnel, ApprovalDecision $record): bool
    {
        return false;
    }

    public function delete(Personnel $personnel, ApprovalDecision $record): bool
    {
        return false;
    }
    ...
    public function forceDelete(Personnel $personnel, ApprovalDecision $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, ApprovalDecision $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, ApprovalDecision $record): bool
    {
        return false;
    }
