...
final class BusinessDevelopmentActivityPolicy
{
    ...
    public function view(Personnel $personnel, BusinessDevelopmentActivity $record): bool
    {
    ...
    public function update(Personnel $personnel, BusinessDevelopmentActivity $record): bool
    {
        return $this->isSystemAdmin($personnel) || $this->permits($personnel, 'update');
    }

    public function delete(Personnel $personnel, BusinessDevelopmentActivity $record): bool
    {
    ...
    public function forceDelete(Personnel $personnel, BusinessDevelopmentActivity $record): bool
    {
        return false;
    }
    ...
    public function restore(Personnel $personnel, BusinessDevelopmentActivity $record): bool
    {
        return false;
    }
    ...
    public function replicate(Personnel $personnel, BusinessDevelopmentActivity $record): bool
    {
        return false;
    }
