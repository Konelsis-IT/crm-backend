...
/**
 * Deviation servisi (surum cocugu, 13 SS8.2): yapi yalniz parent surum
 * taslak/incelemedeyken degisir; status, justification sonradan da guncellenebilir.
 */
final class DeviationService extends AbstractService
{
    use GuardsVersionChildren;

    protected string $model = Deviation::class;

    protected string $orderBy = 'sort_order';

    /** @var list<string> */
    private const MUTABLE_COLUMNS = ['status', 'justification'];
