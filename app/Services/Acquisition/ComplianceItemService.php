...
/**
 * ComplianceItem servisi (surum cocugu, 13 SS8.2): yapi yalniz parent surum
 * taslak/incelemedeyken degisir; compliance_state, note sonradan da guncellenebilir.
 */
final class ComplianceItemService extends AbstractService
{
    ...
    /** @var list<string> */
    private const MUTABLE_COLUMNS = ['compliance_state', 'note'];
