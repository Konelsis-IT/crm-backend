...
/**
 * ContractParty servisi (surum cocugu, 13 SS8.2): yapi yalniz parent surum
 * taslak/incelemedeyken degisir.
 */
final class ContractPartyService extends AbstractService
{
    use GuardsVersionChildren;

    protected string $model = ContractParty::class;
