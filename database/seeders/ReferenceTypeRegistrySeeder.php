...
class ReferenceTypeRegistrySeeder extends Seeder
{
    public function run(): void
    {
        $entries = [
            ...
            ['activity_area', 'activity_areas', 'activity.subjects.activity_area', 'party'],
            ['party_activity_area', 'party_activity_areas', 'activity.subjects.party_activity_area', 'party'],
            ['meeting_plan', 'meeting_plans', 'activity.subjects.meeting_plan', 'party'],
