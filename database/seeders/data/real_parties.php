...
/**
 * Firma takip listesi. RealPartySeeder bu diziyi okur.
 *
 * Surumler:
 *  - Firma_Takip_Listesi.xlsx (14 Eylul 2026), 16 Eylul 2026 kullanici talimatiyla.
 *  - Firma_Takip_Listesi_21_09_2026.xlsx, 21 Eylul 2026 kullanici onayiyla: 6 yeni
 *    firma, var olan firmalara yeni notlar. Var olan firmalarin adi ve eski notlari
 *    (tarihleriyle) korunur. Kullanici kararlari: AZRAX adresi "TUREB uyesi..."
 *    oneki olmadan; Ahlat Enerji'nin adresi Egesa'nin adresi (merkez tasindi);
 *    Egesa'nin iki "EPC firmasi" notundan biri. Var olan kayitlardaki duzeltmeler
 *    (adres, yanlis web sitesi, rakip isareti) FirmaTakipUpdateSeeder'dadir.
 *
 ...
 * 'regulatory_note' (CED / lisans tarihi, Excel M sutunu): 21 Eylul listesinde
 * bu sutun diger sutunlardan kaymis geldi; her projenin degeri eski listedeki
 * kendi satirindan alindi, yeni proje satirlarinda bos (kullanici karari).
 *
...
return [
    ...
    [
        ...
        'notes' => [
            [
                ...
                'channel' => 'other',
                'subject' => null,
                'text' => '(Ahlat Enerji şirket merkezini Egesa\'nın adresine taşıdı.(egesa epc firması))',
            ],
        ],
        'projects' => [
            [
    ...
    [
        ...
        'role' => 'employer',
        'address' => [
            'line1' => 'Eyüp Sultan Mah. 25002. Sk. Kurteks Tekstil Ring İşletmesi No:4 İç Kapı No: A Dulkadiroğlu / Kahramanmaraş',
        ...
        'projects' => [
            [
                'name' => 'UMURBEY RES EDİRNE / ENEZ',
                'status' => 'LİSANS',
                'type' => 'RES EDT',
                'power' => '34,00 MWm / 30,00 MWe 30,00 MWh / 30,00 Mwe',
    ...
    [
        'name' => 'Berit Enerji Tarım ve Hayvancılık Sanayi ve Ticaret Anonim Şirketi',
        'city' => 'Kahramanmaraş',
        'network' => null,
        'priority' => null,
        'role' => 'employer',
        'address' => [
            'line1' => 'Yenişehir Trabzon Kocabaş Apartmanı Kat:2 No: 4 Dulkadiroğlu / Kahramanmaraş',
            'district' => 'Dulkadiroğlu',
            'city' => 'Kahramanmaraş',
        ],
        'channels' => [],
        ...
        'projects' => [
            [
                'name' => 'Fındık Depolamalı GES KAHRAMANMARAŞ / GÖKSUN',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '30,69 MWm / 20,00 MWe 20,00 MWh / 20,00 Mwe',
                'excel_row' => 57,
            ],
        ],
    ],
    ...
    [
        ...
        'notes' => [
            [
                ...
                'channel' => 'email',
                'subject' => null,
                'text' => '(18.09.2026 tanıtım maili atıldı.)',
            ],
        ],
        'projects' => [
            [
    ...
    [
        ...
        'notes' => [
            [
                ...
                'channel' => 'other',
                'subject' => null,
                'text' => '(Asia Global Enerji Şirketi projenin lisansını çıkarıyor sonra Çoka Enerji şirketine devrediyor. Asia Global ile Çoka Enerji şirketlerinin sahipleri aynı kişiler)',
            ],
        ],
        'projects' => [
            [
                'name' => 'ÇOKA RES KARAMAN / MERKEZ',
                'status' => 'LİSANS',
                'type' => 'RES EDT',
    ...
    [
        ...
        'notes' => [
            [
                ...
                'channel' => 'other',
                'subject' => null,
                'text' => '(Depower ve Spi Enerji şirketleri ortaklığıyla işler yürütülüyor. Depower Enerji Pekintaş Grup\'un enerji firması, Spi Enerji ise Pekintaş Grup\'un EPC anahtar kurulum, bakım, işletme firması)',
            ],
        ],
        'projects' => [
            [
    ...
    [
        ...
        'notes' => [
            [
                ...
                'channel' => 'email',
                'subject' => null,
                'text' => '(08.09.2026 tanıtım maili atıldı.)',
            ],
        ],
        'projects' => [
            [
    ...
    [
        ...
        'projects' => [
            ...
            [
                'name' => 'Yozgat Depolamalı GES YOZGAT / BOĞAZLIYAN',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '200,00 MWm / 125,00 MWe 125,00 MWh / 125,00 Mwe',
                'excel_row' => 82,
            ],
        ],
    ],
    ...
    [
        ...
        'projects' => [
            ...
            [
                'name' => 'G3-Batman-1-1 GES BATMAN / MERKEZ',
                'status' => 'LİSANS',
                'type' => 'GES',
                'power' => '19,499 MWm / 15,00 Mwe',
                'excel_row' => 86,
            ],
        ],
    ],
    ...
    [
        ...
        'notes' => [
            [
                ...
                'channel' => 'other',
                'subject' => null,
                'text' => '(Sahibi Eyüp Taymur EGESA\'nın da sahibi EPC firması)',
            ],
        ],
        'projects' => [
            [
    ...
    [
        ...
        'projects' => [
            ...
            [
                'name' => 'Bala-1 Depolamalı GES ANKARA / BALA',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '74,25 MWm / 66,00 MWe 74,304 MWh / 67,50 Mwe',
                'excel_row' => 124,
            ],
            [
                'name' => 'Bala-3 Depolamalı GES ANKARA / BALA',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '55,68 MWm / 49,50 MWe 55,04 MWh / 50,00 Mwe',
                'excel_row' => 125,
            ],
        ],
    ],
    [
        'name' => 'HVK Otomotiv Gayrimenkul Sanayi Ve Ticaret Anonim Şirketi',
        'city' => 'Ankara',
        'network' => null,
        'priority' => null,
        'role' => 'employer',
        'address' => [
            'line1' => 'Macun Mahallesi Fatih Sultan Mehmet Bulv. Acity Avm Apt. No:244/249 Yenimahalle / ANKARA',
        ...
        'projects' => [
            [
                'name' => 'HVK Depolamalı GES ANKARA / KALECİK',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '98,80 MWm / 80,19 MWe 80,19 MWh / 80,19 MWe',
                'excel_row' => 126,
            ],
            [
                'name' => 'HVK 2 Depolamalı GES ANKARA / KALECİK',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '23,57 MWm / 20,21 MWe 40,42 MWh / 40,42 Mwe',
                'excel_row' => 127,
            ],
        ],
    ],
    ...
    [
        ...
        'projects' => [
            ...
            [
                'name' => 'Toroslar Depolamalı GES MERSİN / TOROSLAR',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '24,00 MWm / 24,00 MWe 24,00 MWh / 24,00 Mwe',
                'excel_row' => 141,
            ],
        ],
    ],
    ...
    [
        ...
        'projects' => [
            [
                'name' => 'KARAÇOBAN DEPOLAMALI GES ERZURUM / HINIS',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '30,00 MWm / 20,00 MWe 20,00 MWh / 20,00 Mwe',
                'excel_row' => 148,
            ],
            [
    ...
    [
        'name' => 'Met Yeşil Enerji Üretim Anonim Şirketi',
        'city' => 'Ankara',
        'network' => null,
        'priority' => null,
        'role' => 'employer',
        'address' => [
            'line1' => 'Huzur Mah. 1139. Sok. No:6/6 Çankaya / ANKARA',
            'district' => 'Çankaya',
            'city' => 'Ankara',
        ],
        'channels' => [
            [
                'type' => 'phone',
                'value' => '+90 312 473 29 95',
            ],
            [
                'type' => 'email',
                'value' => 'info@metgrup.com',
            ],
        ],
        'contacts' => [],
        'notes' => [],
        'projects' => [
            [
                'name' => 'Konya Taşkent Depolamalı GES KONYA / TAŞKENT',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '12,29 MWm / 10,00 MWe 20,00 MWh / 20,00 Mwe',
                'excel_row' => 166,
            ],
        ],
    ],
    [
        'name' => 'MFA Grup Enerji Ticaret Anonim Şirketi',
        'city' => 'Ankara',
        'network' => null,
        'priority' => null,
        'role' => 'employer',
        'address' => [
            'line1' => 'Kazım Özalp Mah. Hirfanlı Sok. İşyeri No: 2A İç Kapı No: 1 Çankaya / ANKARA',
            'district' => 'Çankaya',
            'city' => 'Ankara',
        ],
        'channels' => [
            [
                'type' => 'website',
                'value' => 'https://www.mfainsaat.net',
            ],
            [
                'type' => 'phone',
                'value' => '+90 312 440 42 25',
            ],
            [
                'type' => 'email',
                'value' => 'info@mfainsaat.net',
            ],
        ],
        'contacts' => [],
        'notes' => [],
        'projects' => [
            [
                'name' => 'Yeşilhisar Depolamalı GES NEVŞEHİR / ÜRGÜP',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '127,38 MWm / 100,00 MWe 200,00 MWh / 200,00 Mwe',
                'excel_row' => 167,
            ],
        ],
    ],
    ...
    [
        'name' => 'Polateliges Enerji Üretim Sanayi ve Ticaret Limited Şirketi',
        'city' => 'İstanbul',
        'network' => null,
        'priority' => null,
        'role' => 'employer',
        'address' => [
            'line1' => 'Göztepe Mah. İnönü Cad. Başkule Plaza Sit. No: 122/131 Bağcılar / İSTANBUL',
            'district' => 'Bağcılar',
            'city' => 'İstanbul',
        ],
        'channels' => [],
        ...
        'projects' => [
            [
                'name' => 'G3-Kilis-2-1 GES KİLİS / MUSABEYLİ',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '10,00 MWm / 10,00 MWe 10,00 MWh / 10,00 MWe',
                'excel_row' => 197,
    ...
    [
        ...
        'projects' => [
            ...
            [
                'name' => 'Sazlıdere Depolamalı RES TEKİRDAĞ / SARAY',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '21,00 MWm / 21,00 MWe 42,00 MWh / 42,00 Mwe',
                'excel_row' => 229,
            ],
        ],
    ],
    ...
    [
        'name' => 'TİMUR YENİLENEBİLİR ENERJİ ÜRETİM ANONİM ŞİRKETİ',
        'city' => 'Ankara',
        'network' => null,
        'priority' => null,
        'role' => 'employer',
        ...
        'notes' => [
            [
                ...
                'channel' => 'other',
                'subject' => null,
                'text' => 'EPC Firması olan Egesa Şirketi Üretim Lisanslarını çıkarıyor. Daha sonra aynı konumda ve Egesa\'nın da kurucusu ve sahibi olan Eyüp Taymur, Timur Yenilenebilir Enerji Şirketi\'ni kuruyor. Sivaslı-1 ve Karahallı-1 projelerinin lisanslarını bu şirkete devrediyor. Timur Yenilenebilr Enerji Şirketini de Lidersan Sağ. ve Gıd. Ür. A.Ş. şirketi\'ne devrediyor.',
            ],
        ],
        'projects' => [
            [
                'name' => 'Karahallı-1 Depolamalı GES V',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '27,98 MWm / 18,00 MWe 18,2108 MWh / 18,00 Mwe',
                'excel_row' => 238,
            ],
            [
                'name' => 'Sivaslı-1 Depolamalı GES UŞAK / SİVASLI',
                'status' => 'LİSANS',
                'type' => 'GES EDT',
                'power' => '44,99 MWm / 30,00 MWe 30,3513 MWh / 30,00 Mwe',
                'excel_row' => 239,
            ],
        ],
    ],
    ...
    [
        ...
        'projects' => [
            ...
            [
                'name' => 'Bozüyük Depolamalı RES BİLECİK / BOZÜYÜK',
                'status' => 'LİSANS',
                'type' => 'RES EDT',
                'power' => '53,00 MWm / 50,00 MWe 50,00 MWh / 50,00 Mwe',
                'excel_row' => 251,
